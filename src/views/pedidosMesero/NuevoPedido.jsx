...
import { addPedidoMesero } from "actions/pedidos";
import {
  Button,
  Card,
  CardHeader,
...
function Mesa({ mesa, addPedidoMesero, setClose }) {
  ...
  const handleSubmit = (e) => {
    ...
    pedidos.some((fac) => fac.cantidad <= 0)
      ...
      : addPedidoMesero(factura, pedidos);
    !open && handleOpen();
  };
...
const mapDispatchToProps = { addPedidoMesero, setClose };
